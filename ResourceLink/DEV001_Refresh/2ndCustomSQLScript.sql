USE RLD
GO
--Delete data in current RLD tables
...
GO
--Move data from Temp database to RLD database
INSERT INTO [QM_DEV_TEAM].[QMUL_VERIFIED_AS_NOT_DUPE]
SELECT * FROM [RLD_TABLESAFE].[QM_DEV_TEAM].[QMUL_VERIFIED_AS_NOT_DUPE_staging];
GO
INSERT INTO [QM_DEV_TEAM].[QMUL_GRADE_CATEGORIES]
SELECT * FROM [RLD_TABLESAFE].[QM_DEV_TEAM].[QMUL_GRADE_CATEGORIES_staging]
GO
INSERT INTO [QM_DEV_TEAM].[QMUL_FEED_EXCEPTIONS]
SELECT * FROM [RLD_TABLESAFE].[QM_DEV_TEAM].[QMUL_FEED_EXCEPTIONS_staging];
GO
...
( [PK]
      ...
      ,[LONG_DESC]
      ,[CATEGORY])
SELECT * FROM [RLD_TABLESAFE].[QM_DEV_TEAM].[QMUL_ALL_POTENTIAL_POSTS_DUPES_staging];
GO
INSERT INTO [dbo].D1117M
SELECT * FROM [RLD_TABLESAFE].[dbo].[D1117M_staging];
GO
INSERT INTO [dbo].D1993M
SELECT * FROM [RLD_TABLESAFE].[dbo].[D1993M_staging];
GO
INSERT INTO [dbo].D256M
SELECT * FROM [RLD_TABLESAFE].[dbo].[D256M_staging];
GO
INSERT INTO [dbo].D8500M
SELECT * FROM [RLD_TABLESAFE].[dbo].[D8500M_staging];
GO
INSERT INTO [dbo].D963M
SELECT * FROM [RLD_TABLESAFE].[dbo].[D963M_staging];
GO
INSERT INTO [dbo].D993M
SELECT * FROM [RLD_TABLESAFE].[dbo].[D993M_staging];
GO
--Clear session files 
