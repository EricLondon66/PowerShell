...
function Main{
 ...
 Param([string]$sourceInstance, [string]$sourceDbName, [string]$sourcePath, [string]$destinationInstance, [string]$destinationDbName )
...
Main $sourceInstance $sourceDbName $sourcePath $destinationInstance $destinationDbName 
